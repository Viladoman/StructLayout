...
namespace StructLayout.Editor
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ReportIssueCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private ReportIssueCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static ReportIssueCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new ReportIssueCommand(package, commandService);
        }
